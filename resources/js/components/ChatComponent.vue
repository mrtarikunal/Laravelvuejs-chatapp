                        ...
                        <li v-for="friend in friends" :key="friend.id">
                            <div class="d-flex bd-highlight">
                                <div class="img_cont">
                                    ...
                                    <span class="online_icon" v-if="friend.online"></span>
                                    <span class="online_icon offline" v-if="friend.online === false"></span>
                                </div>
                                <div class="user_info">
									<span>
										<a href="" @click.prevent="openChat(friend)" style="color: black">{{friend.name}}
                                     <span class="text-danger" v-if="friend.session && (friend.session.unreadCount > 0)">{{friend.session.unreadCount}}</span>
										</a>
									</span>
                                    <p v-if="friend.online">{{friend.name}} is online</p>
                                    <p v-else>{{friend.name}} is offline</p>
                                </div>
                            </div>
                        </li>
                    </ui>
